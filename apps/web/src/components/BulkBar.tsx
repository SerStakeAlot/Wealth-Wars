    ...
    <div className="bulkBar">
      ...
      <style jsx>{`
        .bulkBar {
          ...
          padding: 16px 20px; box-shadow: 0 -10px 30px rgba(0,0,0,0.45);
        ...
        .actionBtn {
          ...
          padding: 10px 16px; border: 1px solid rgba(255,255,255,0.16);
        ...
        .upgrades { border-color: rgba(34,197,94,0.4); color: #22c55e; }
        .upgrades:hover { background: rgba(34,197,94,0.1); }
        .prestige { border-color: rgba(245,158,11,0.4); color: #f59e0b; }
        .prestige:hover { background: rgba(245,158,11,0.1); }
        .events { border-color: rgba(139,92,246,0.4); color: #8b5cf6; }
